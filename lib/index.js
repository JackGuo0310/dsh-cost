 ...
 *
 * This is the plugin's own row identity, not the npm package name: it must match
 * the `id` of the row in cordis.patch.yml (whose `name` is the package
 * `@jackguo0310/dsh-cost`), and the id the client half registers with the browser
 * module system.
 */
